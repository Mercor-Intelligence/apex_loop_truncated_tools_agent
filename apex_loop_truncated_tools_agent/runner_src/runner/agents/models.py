...
class AgentConfigIds(StrEnum):
    ...
    REACT_TOOLBELT_ANTHROPIC_WORKAROUND = "react_toolbelt_anthropic_workaround"
    LOOP_ANTHROPIC_WORKAROUND = "loop_anthropic_workaround"
    # Backwards-compat single-model shims over REACT_TOOLBELT_ANTHROPIC_WORKAROUND.
    # Kept so existing Agent/orchestrator records keep resolving; prefer the
    # generic agent for new configs.
    REACT_TOOLBELT_CLAUDE_OPUS_47_WORKAROUND = (
        "react_toolbelt_claude_opus_47_workaround"
    )
    REACT_TOOLBELT_CLAUDE_QUESO_EAP_WORKAROUND = (
        "react_toolbelt_claude_queso_eap_workaround"
    )
    ...
    OPENHANDS_AGENT = "openhands_agent"
    OPENCODE_AGENT = "opencode_agent"
    PROMETHEUS_STREAM_AGENT = "prometheus_stream_agent"
    SPARTA_EXTERNAL_AGENT = "sparta_external_agent"
    USER_SIM_HARNESS_AGENT = "user_sim_harness_agent"
    CONFIGURABLE_USER_SIM_AGENT = "configurable_user_sim_agent"
    SIMPLE_USER_SIM_AGENT = "simple_user_sim_agent"
    SCRIPTED_USER_SIM_AGENT = "scripted_user_sim_agent"
    ...
    REACT_TOOLBELT_SIMPLE_USER_SIM_AGENT = "react_toolbelt_simple_user_sim_agent"
    GEMINI_NATIVE_AGENT = "gemini_native_agent"
    LIGHTHOUSE_CODE_AGENT = "lighthouse_code_agent"
    AIDE_CODE_AGENT = "aide_code_agent"
    GOLDEN_TRIM_AGENT = "golden_trim_agent"
    DEFERRED_TOOLS_AGENT = "deferred_tools_agent"
    LANGUAGE_GUARD_HARNESS_AGENT = "language_guard_harness_agent"
    NEON_SYNTHETIC_SEED_AGENT = "neon_synthetic_seed_agent"
    GEMINI_CLI_AGENT = "gemini_cli_agent"
    CODEX_AGENT = "codex_agent"
    WEB_RESEARCH_AGENT = "web_research_agent"
    SINGLE_SHOT_MULTIMODAL = "single_shot_multimodal"
    CONTEXT_HARNESS_AGENT = "context_harness_agent"
    SUMMARIZATION_HARNESS = "summarization_harness"
    ANTIGRAVITY_AGENT = "antigravity_agent"
    RISK_AGENT_V0 = "risk_agent_v0"
    RISK_AGENT_V1 = "risk_agent_v1"
    RISK_AGENT_PROFILE = "risk_agent_profile"
